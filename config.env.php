...
define('CAMUNDA_CONNECTOR_DEFAULT_RETRY_TIMEOUT', getenv('CAMUNDA_CONNECTOR_DEFAULT_RETRY_TIMEOUT'));
define('CAMUNDA_CONNECTOR_DEFAULT_RETRIES', getenv('CAMUNDA_CONNECTOR_DEFAULT_RETRIES'));
